                ...
                <div class="col  d-none d-lg-block rounded">
                    <h1 class="container-tittle ">Menu</h1>
                            ...
                            <form method="POST" action="userMenu">
                               ...
                               %>
                                    <input type="text" class="form-control" style="display:none;" name="rut" id="rut" value="<%= daoUsuario.getRut() %>" readonly>
                                    
                                    <input type="submit" class="btn-check"  name="btn" id="evaluaciones" value="evaluaciones">
                                    <label class="btn btn-warning"  for="evaluaciones">Evaluaciones</label>

                                    <input type="submit" class="btn-check "  name="btn" id="update" value="update">
                                    <label class="btn btn-warning" for="update">Modificar datos</label>
