                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-auto">
                                <h1 class="nav-h1">ADMINISTRADOR</h1>
                            </ul>
                        </div>
            ...
            <div class="row ">
                <div class="col d-none d-lg-block rounded">
                   ...
                   <!-- Menú -->
                    ...
                    <div class="btn-group-vertical mt-3 mb-3">
                        ...
                        <label class="btn btn-warning" for="addmember">Agregar miembro</label>

                        <input type="radio" class="btn-check"  name="btnradio" onclick="mostrar()" id="adduser" value="adduser" autocomplete="off">
                        <label class="btn btn-warning" for="adduser">Crear usuario</label>

                        <input type="radio" class="btn-check"  name="btnradio" onclick="mostrar()" id="delete" value="delete" autocomplete="off">
                        <label class="btn btn-warning" for="delete">Eliminar miembro</label>
                    </div>
                    <!-- Info usuario -->
                    <h3 class="hs">Información Usuario</h3>
                    <div class="mb-2">
                            <label for="userinf" class="form-label">Usuario</label>
                            <input type="text" class="form-control" style="width: 280px" name="userinf" id="userinf" value="admin" readonly>
                    </div>
                    <div class="mb-4">
                            <label for="correoinf" class="form-label">Correo</label>
                            <input type="text" class="form-control" style="width: 280px" name="correoinf" id="correoinf" value="admin@fitlab.cl" readonly>
                    </div>
                </div>
               <!-- Div miembro-->
                <div class="col  rounded-end px-5 py-5 " id="member" style="display:none" >
                    <form method="POST" action="RegistroMiembro2">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="form-control" name="telefono" required id="telefono">
                        </div>
                        <div class="mb-4">
               ...
               <!-- Div user -->
                <div class="col  rounded-end px-5 py-5 " id="user" style="display:none" >
                    <form method="POST" action="RegistroUsuario2">
                        <div class="mb-4">
                            <label for="idusuario" class="form-label">ID usuario</label>
                            <input type="number" class="form-control" name="idusuario" required id="idusuario">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" name="contrasena" required id="contrasena">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="rut" class="form-label">RUT/DNI</label>
                            <input type="text" class="form-control" required name="rut" id="rut">
                        </div>
               ...
               <!-- Div delete -->
                <div class="col  rounded-end px-5 py-5 " id="del" style="display:none" >
                    <form method="POST" action="DeleteByRut">
                        <div class="mb-4">
                            <label for="rut" class="form-label">RUT/DNI</label>
                            <input type="text" class="form-control" required name="rut" id="rut">
                        </div>
